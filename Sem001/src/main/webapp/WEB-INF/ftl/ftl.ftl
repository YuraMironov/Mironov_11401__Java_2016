                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class="">
                            <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                <img src="resource/images/img.jpg" alt="">John Doe
            ...
            <div class="row tile_count">
                <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                    ...
                    <div class="right">
                        ...
                        <span class="count_bottom"><i class="green">4% </i> From schetchik Week</span>
                    </div>
                </div>
                <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                    <div class="left"></div>
                    <div class="right">
                        ...
                        <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>3% </i> From schetchik Week</span>
                    </div>
                </div>
                <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                    <div class="left"></div>
                    <div class="right">
                        ...
                        <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> From schetchik Week</span>
                    </div>
                </div>
                <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                    <div class="left"></div>
                    <div class="right">
                        ...
                        <span class="count_bottom"><i class="red"><i class="fa fa-sort-desc"></i>12% </i> From schetchik Week</span>
                    </div>
                </div>
                <div class="animated flipInY col-md-2 col-sm-4 col-xs-4 tile_stats_count">
                    <div class="left"></div>
